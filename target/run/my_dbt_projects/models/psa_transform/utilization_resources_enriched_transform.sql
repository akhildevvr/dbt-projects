  ...
  create or replace   view EIO_INGEST.ENGAGEMENT_TRANSFORM.utilization_resources_enriched
...
was_new_table,
 ...
 IFF ( Functional_Group in ('Functional-Spacemaker'), 'Other Teams' , active_site ) as active_site_new
