  ...
  create or replace   view eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_deferred_local_cur_rev
...
FROM eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_deferred_local_cur_rev
GROUP  BY
    ProjectID
  );
