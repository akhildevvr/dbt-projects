  ...
  create or replace   view eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_expect_labor_local_cur_rev
...
LEFT JOIN eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_project_budget_local_cur AS PROJECT_BUDGET
