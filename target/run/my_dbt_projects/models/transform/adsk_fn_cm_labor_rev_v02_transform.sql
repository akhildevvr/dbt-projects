  ...
  create or replace   view eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_labor_rev_v02
...
SELECT
     ...
     LEFT JOIN eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_project_budget as ProjBudget
     ...
     LEFT JOIN eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_deferred_rev as DEFERRED_REV
