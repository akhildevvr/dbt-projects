  ...
  create or replace   view eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_deferred_local_cur_rev
...
*/
    ...
    FULL OUTER JOIN eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_expect_labor_local_cur_rev as MONTHLY_EXPECT_LABOR_REV
    ...
    FULL OUTER JOIN eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_chrg_rev_local_cur as MONTHLY_CHRG_REV
    ...
    FULL OUTER JOIN (SELECT
                      ...
                      , MonthRecognized
                      , RecognizedRevenue
                    FROM eio_ingest.tenrox_sandbox_transform.adsk_fn_cm_monthly_rec_local_cur_rev
