        ...
        create or replace transient table EIO_INGEST.S3_INGEST_STAGE.customer_segmentation_predictions  as
        (/*
...
from EIO_INGEST.S3_INGEST_STAGE.customer_segmentation_predictions_ext
        );
