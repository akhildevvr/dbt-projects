...
{{ config(
    alias='adsk_cm_forecast_chrg_rev_local_cur_v02_stacked'
) }}
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcbaseline')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcbaselinebudget')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcbltmpl')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblsec')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblseclabel')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblcat')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblcatlabel')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblitem')}}
),
...
(
    ...
    *
    FROM
    {{ source('tenrox_private','trvfcblitemdata')}}
),
...
(
    ...
    *
    FROM
    {{ ref('adsk_cm_project_details_transform')}}
),
