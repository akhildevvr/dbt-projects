{{ config(
    alias='adsk_cm_forecast_chrg_cost'
) }}
...
SELECT 
    ...
    LEFT OUTER JOIN
        {{ source('tenrox_private', 'trvfcbaselinebudget') }} trvfcbaselinebudget 
    ...
    INNER JOIN
        {{ source('tenrox_private', 'trvfcblseclabel') }} trvfcblseclabel
